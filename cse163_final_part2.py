...
def plot_geo_by_month(df, countries, m, t):
    """
      Plot a map of global Covid cases by given type and month
    """
    df_type = df
...
def plot_by_month(df, m, t):
    """
      Makes a bar plot of global Covid cases by Country/Region with
...
def long_plot_by_month(df, m, t):
    """
      Makes a line plot of global Covid cases by Longitude with
      given type and month
    """
    df_type = df
    is_m = df_type['Last_Update'].dt.month == m
